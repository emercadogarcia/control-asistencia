...
<body>
    ...
    <main class="container page">
        ...
        <div class="layout">
            <section class="card">
                <h2><?php echo e($sucursalEdit ? 'Editar sucursal' : 'Nueva sucursal'); ?></h2>
                <p><?php echo e($sucursalEdit ? 'Actualiza la informacion sin salir del modulo.' : 'Registra una sucursal con sus datos base de operacion.'); ?></p>
                ...
                <form method="POST" action="<?php echo e($sucursalEdit ? route('configuracion.sucursales.actualizar', $sucursalEdit->id) : route('configuracion.sucursales.crear')); ?>">
                    <?php echo csrf_field(); ?>

                    <div class="field">
                        <label for="nombre">Nombre</label>
                        <input id="nombre" type="text" name="nombre" value="<?php echo e(old('nombre', $sucursalEdit->nombre ?? '')); ?>" placeholder="Ej. Central, Norte o Planta 2" required>
                    </div>

                    <div class="field">
                        <label for="direccion">Direccion</label>
                        <textarea id="direccion" name="direccion" placeholder="Describe la direccion o referencia principal"><?php echo e(old('direccion', $sucursalEdit->direccion ?? '')); ?></textarea>
                    </div>

                    <div class="field">
                        <label for="telefono">Telefono</label>
                        <input id="telefono" type="text" name="telefono" value="<?php echo e(old('telefono', $sucursalEdit->telefono ?? '')); ?>" placeholder="Ej. 70000000">
                    </div>

                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary"><?php echo e($sucursalEdit ? 'Guardar cambios' : 'Crear sucursal'); ?></button>
                        <?php if($sucursalEdit): ?>
                            <a href="<?php echo e(route('configuracion.sucursales')); ?>" class="btn btn-secondary">Cancelar</a>
                        <?php endif; ?>
                    </div>
                </form>
            </section>
            ...
            <section>
                <div class="metrics">
                    <div class="metric">
                        ...
                        <strong><?php echo e($sucursales->total()); ?></strong>
                    </div>
                    <div class="metric">
                        <span>Personal asignado</span>
                        <strong><?php echo e($sucursales->sum('personals_count')); ?></strong>
                    </div>
                    <div class="metric">
                        <span>Turnos configurados</span>
                        <strong><?php echo e($sucursales->sum('turnos_count')); ?></strong>
                    </div>
                </div>
                ...
                <div class="card">
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><strong><?php echo e($sucursal->nombre); ?></strong></td>
                                        <td><?php echo e($sucursal->direccion ?: 'Sin direccion'); ?></td>
                                        <td><?php echo e($sucursal->telefono ?: 'Sin telefono'); ?></td>
                                        <td><?php echo e($sucursal->personals_count); ?></td>
                                        <td><?php echo e($sucursal->turnos_count); ?></td>
                                        <td><span class="badge">Activa</span></td>
                                        <td>
                                            <div class="actions">
                                                <a href="<?php echo e(route('configuracion.sucursales.editar', $sucursal->id)); ?>" class="icon-btn" title="Editar">
                                                ...
                                                <a href="<?php echo e(route('configuracion.sucursales.eliminar', $sucursal->id)); ?>" class="icon-btn delete" title="Dar de baja" onclick="return confirm('Se dara de baja esta sucursal. Deseas continuar?')">
                                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    ...
                    <div style="margin-top: 16px;">
                        <?php echo e($sucursales->appends(request()->query())->links()); ?>
