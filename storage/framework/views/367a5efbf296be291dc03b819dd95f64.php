...
<head>
    ...
    <title>Nueva Asistencia - Control de Asistencia</title>
    <style>
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <p>Formulario para registrar nueva asistencia.</p>
            <nav>
                <a href="/asistencia">← Volver a Asistencia</a>
            </nav>
        </div>
    </div>
    <script>
...
<?php /**PATH /workspace/resources/views/asistencia/create.blade.php ENDPATH**/ ?>