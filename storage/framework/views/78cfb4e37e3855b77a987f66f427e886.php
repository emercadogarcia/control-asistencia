...
<body>
    ...
    <div class="container">
        <div class="form-card">
            ...
            <form method="POST" action="<?php echo e(route('configuracion.turnos.actualizar', $turno->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="sucursal_id" required>
                        ...
                        <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sucursal->id); ?>" <?php echo e($turno->sucursal_id === $sucursal->id ? 'selected' : ''); ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" value="<?php echo e($turno->nombre); ?>" required>
                </div>

                <div class="form-group">
                    <label>Hora Entrada (HH:MM)</label>
                    <input type="time" name="hora_entrada" value="<?php echo e($turno->hora_entrada); ?>" required>
                </div>

                <div class="form-group">
                    <label>Hora Salida (HH:MM)</label>
                    <input type="time" name="hora_salida" value="<?php echo e($turno->hora_salida); ?>" required>
                </div>

                <div class="form-group">
                    <label>Tolerancia (minutos)</label>
                    <input type="number" name="tolerancia_min" value="<?php echo e($turno->tolerancia_min); ?>" min="0">
                </div>

                <button type="submit" class="btn-submit">Actualizar Turno</button>
            </form>

            <a href="<?php echo e(route('configuracion.turnos')); ?>" class="link-back">← Volver</a>
        </div>
    </div>
...
<?php /**PATH /workspace/resources/views/configuracion/turno-editar.blade.php ENDPATH**/ ?>