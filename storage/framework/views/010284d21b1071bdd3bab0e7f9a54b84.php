...
<body>
    <header>
        <div class="container header-inner">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-secondary">Dashboard</a>
        </div>
    </header>
            ...
            <section>
                <div class="metrics">
                    <div class="metric">
                        ...
                        <strong><?php echo e($totalHoy); ?></strong>
                    </div>
                    <div class="metric">
                        <span>Presentes</span>
                        <strong><?php echo e($presentesHoy); ?></strong>
                    </div>
                    <div class="metric">
                        <span>Tardanzas</span>
                        <strong><?php echo e($tardanzasHoy); ?></strong>
                    </div>
                    <div class="metric">
                        <span>Sin salida</span>
                        <strong><?php echo e($pendientesSalida); ?></strong>
                    </div>
                </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $asistencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asistencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><strong><?php echo e($asistencia->personal->nombre_completo ?? trim(($asistencia->personal->nombre ?? '') . ' ' . ($asistencia->personal->apellido ?? ''))); ?></strong></td>
                                        <td><?php echo e($asistencia->personal->ci ?? 'Sin CI'); ?></td>
                                        <td><?php echo e($asistencia->personal->sucursal->nombre ?? 'Sin sucursal'); ?></td>
                                        <td><?php echo e($asistencia->hora_entrada ? $asistencia->hora_entrada->format('H:i:s') : 'Sin registro'); ?></td>
                                        <td><?php echo e($asistencia->hora_salida ? $asistencia->hora_salida->format('H:i:s') : 'Pendiente'); ?></td>
                                        <td>
                                            <?php if($asistencia->hora_salida): ?>
                                                <span class="badge <?php echo e($asistencia->estado === 'tardanza' ? 'badge-tardanza' : 'badge-presente'); ?>">
                                                    <?php echo e($asistencia->estado === 'tardanza' ? 'Tardanza' : 'Completo'); ?>

                                                </span>
                                            <?php else: ?>
                                                <span class="badge badge-pendiente">
                                                    <?php echo e($asistencia->estado === 'tardanza' ? 'Tardanza pendiente salida' : 'Pendiente salida'); ?>
