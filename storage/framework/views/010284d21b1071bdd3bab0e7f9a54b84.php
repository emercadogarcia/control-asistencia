...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <p>Página de registro y visualización de asistencia del personal.</p>
            <nav>
                <a href="/dashboard">← Volver al Dashboard</a>
                <a href="/asistencia/crear">Registrar Asistencia</a>
                <a href="/asistencia/reportes">Ver Reportes</a>
            </nav>
        </div>
    </div>
    <script>
