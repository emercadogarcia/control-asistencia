...
<body>
    ...
    <div class="container">
        <div class="form-card">
            ...
            <form method="POST" action="<?php echo e(route('configuracion.sucursales.actualizar', $sucursal->id)); ?>">
                <?php echo csrf_field(); ?>

                <div class="form-group">
                    <label>Nombre</label>
                    <input type="text" name="nombre" value="<?php echo e($sucursal->nombre); ?>" required>
                </div>

                <div class="form-group">
                    <label>Dirección</label>
                    <textarea name="direccion"><?php echo e($sucursal->direccion); ?></textarea>
                </div>

                <div class="form-group">
                    <label>Teléfono</label>
                    <input type="text" name="telefono" value="<?php echo e($sucursal->telefono); ?>">
                </div>

                <button type="submit" class="btn-submit">Actualizar Sucursal</button>
            </form>

            <a href="<?php echo e(route('configuracion.sucursales')); ?>" class="link-back">← Volver</a>
        </div>
    </div>
...
<?php /**PATH /workspace/resources/views/configuracion/sucursal-editar.blade.php ENDPATH**/ ?>