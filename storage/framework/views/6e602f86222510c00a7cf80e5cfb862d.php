...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .field input, .field select, .field textarea { width: 100%; padding: 11px 13px; border: 1px solid #cbd5e1; border-radius: 14px; background: #fff; font-size: 14px; }
        ...
        .check-row { display: flex; align-items: center; gap: 10px; margin-top: 18px; padding: 12px 14px; border-radius: 14px; background: #f8fafc; border: 1px solid #e2e8f0; color: #334155; }
        .check-row input { width: auto; }
        .form-actions { display: flex; gap: 10px; flex-wrap: wrap; margin-top: 18px; }
        .btn { display: inline-flex; align-items: center; justify-content: center; gap: 8px; border-radius: 14px; border: 1px solid transparent; padding: 11px 15px; font-weight: 600; text-decoration: none; cursor: pointer; transition: transform 0.2s ease, box-shadow 0.2s ease; }
        ...
        .badge.holiday { background: #ffedd5; color: #c2410c; }
        ...
        <div class="layout">
            ...
            <section>
                ...
                <div class="card">
                    ...
                    <p>Administra las fechas registradas con acciones compactas e iconograficas.</p>
