...
<body>
    <header>
        ...
        <div class="fecha-hoy">Hoy: {{ $hoy->format('d/m/Y - l') }}</div>
    ...
    <div class="container">
        <div class="section">
            ...
            <div class="grid">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $totalPersonal }}</div>
                </div>
                <div class="stat-card presente">
                    <div class="stat-label">Presentes</div>
                    <div class="stat-number">{{ $presentesHoy }}</div>
                </div>
                <div class="stat-card tardanza">
                    <div class="stat-label">Tardanzas</div>
                    <div class="stat-number">{{ $tardanzasHoy }}</div>
                </div>
                <div class="stat-card ausente">
                    <div class="stat-label">Ausentes</div>
                    <div class="stat-number">{{ $auentesHoy }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="menu-rapido">
                <a href="{{ route('asistencia.crear') }}" class="menu-item">
                    <div style="font-size: 24px; margin-bottom: 10px;">✍️</div>
                    <strong>Marcar Asistencia</strong>
                </a>
                <a href="{{ route('personal.index') }}" class="menu-item">
                    <div style="font-size: 24px; margin-bottom: 10px;">👥</div>
                    <strong>Gestionar Personal</strong>
                </a>
                <a href="{{ route('asistencia.reporte') }}" class="menu-item">
                    <div style="font-size: 24px; margin-bottom: 10px;">📈</div>
                    <strong>Reportes</strong>
                </a>
                <a href="{{ route('configuracion.index') }}" class="menu-item config">
                    <div style="font-size: 24px; margin-bottom: 10px;">⚙️</div>
                ...
                <table>
                    ...
                    <tbody>
                        @foreach($asistenciasRecientes as $asistencia)
                            <tr>
                                <td><strong>{{ $asistencia->personal->nombre_completo }}</strong></td>
                                <td>{{ $asistencia->personal->ci }}</td>
                                <td><span class="hour">{{ $asistencia->hora_entrada->format('H:i') }}</span></td>
